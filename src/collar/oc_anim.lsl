...
AnimMenu(key kID, integer iAuth)
{
  ...
  if (llGetInventoryType("~stiff") == INVENTORY_ANIMATION) lButtons += Checkbox(g_bPosture, "Posture");
...
{// Wrapper to send menu back to the AO's menu // com script needs to send this from root
